...
$sql1="INSERT INTO `3826676_yatin`.`plasma` (`name`, `address`, `city`, `state`, `phone`, `comment`,`time`) VALUES ('$name', '$address', '$city', '$state', '$phone', '$comment',current_timestamp());";
...
@media (max-width: 367px){
    ...
    <div class="container div1">
      ...
      <h4 class="head1">(IF YOU WANT TO DONATE PLASMA)</h4>
      <?php
      if($insert==true){
      echo "<u><p class='success'>Thanks For Submitting Your Form</p></u>";
    }
    ?>
      <form action="plasma.php" method="POST" class="form">
        <div class="form-row">
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control text1" id="comment"
              placeholder="Additional Information like b+ plasma donor available,my phone no.39498390483 ..."
              name="comment">
          </div>
          <div class="form-group">
